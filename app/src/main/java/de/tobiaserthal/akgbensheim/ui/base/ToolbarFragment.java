...
public abstract class ToolbarFragment extends Fragment {
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int toolBarPaddingSize = ViewUtils.getPixelSize(context, R.attr.actionBarSize);
    ...
    public float getToolbarTranslation() {
        return ViewHelper.getTranslationY(getToolbar());
    }
    ...
    public boolean toolbarIsShown() {
        return ViewHelper.getTranslationY(getToolbar()) >= 0;
    }
