...
public class EventHostFragment extends TabbedHostFragment {
    ...
    private final SwipeRefreshLayout.OnRefreshListener refreshListener = new SwipeRefreshLayout.OnRefreshListener() {
        ...
        public void onRefresh() {
            ...
            if(allowed) {
                SyncUtils.forceRefresh(ModelUtils.EVENTS);
            } else {
    ...
    public static class Builder extends TabbedHostFragment.Builder {
        ...
        @Override
        public EventHostFragment build() {
            return build(EventHostFragment.class);
        }
    }
}
